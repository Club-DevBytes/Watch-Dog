...
import { SuspiciousRef } from "../config/firebase";
...
class Dashboard extends React.Component {
  ...
  componentDidMount() {
    ...
    SuspiciousRef.once("value", function(snapshot) {
      snapshot.forEach(function(childSnapshot) {
        var date = childSnapshot.key;
        var childData = childSnapshot.val();

        var timeId = childData.key;

        // console.log(date);
        // console.log(childData);

        for (timeId in childData) {
          // console.log(personId);

          var subDetails = childData[timeId];
...
// Bukani person face not detected