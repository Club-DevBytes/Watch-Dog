...
personList = [] 
KEY = '5c7e651b539b4b579e949ab9e6a7aa08'

# faceID = ['c78ff3cb-e592-458f-8612-99eded91d3e4']


from twilio.rest import Client
auth_token = '73bbe8fc16cc510655db3a839eac7d69' # twilio authorization token
account_sid = 'ACe78a47d368e82dcecfe9166f02583016'
...
import pyrebase
config = {
  "apiKey": "AIzaSyDOnFvVlO7UUzaSX9zXBBr7eTXF2Z1AxW0",
...
def twilio(name,phoneNo, imageLink):
    ...
    message1 = client.messages.create(to= phoneNo , from_='+12018775310', body = msg, media_url=imageLink)
...
if personList == []: # if post is empty (meaning no face found)
                ...
                db.child("Intruders").child(date).child(time_set).set(imgUrl)
